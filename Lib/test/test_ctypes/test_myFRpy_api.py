...
class MyFRpyAPITestCase(unittest.TestCase):

    def test_PyBytes_FromStringAndSize(self):
        PyBytes_FromStringAndSize = myFRpyapi.PyBytes_FromStringAndSize
    ...
    def test_PyString_FromString(self):
        myFRpyapi.PyBytes_FromString.restype = py_object
        myFRpyapi.PyBytes_FromString.argtypes = (c_char_p,)

        s = b"abc"
        refcnt = grc(s)
        pyob = myFRpyapi.PyBytes_FromString(s)
    ...
    def test_PyLong_Long(self):
        ref42 = grc(42)
        myFRpyapi.PyLong_FromLong.restype = py_object
        self.assertEqual(myFRpyapi.PyLong_FromLong(42), 42)

        self.assertEqual(grc(42), ref42)

        myFRpyapi.PyLong_AsLong.argtypes = (py_object,)
        myFRpyapi.PyLong_AsLong.restype = c_long

        res = myFRpyapi.PyLong_AsLong(42)
    ...
    def test_PyObj_FromPtr(self):
        s = "abc def ghi jkl"
        ref = grc(s)
        # id(myFRpy-object) is the address
    ...
    def test_PyOS_snprintf(self):
        PyOS_snprintf = myFRpyapi.PyOS_snprintf
