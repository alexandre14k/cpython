...
class TestPy2MigrationHint(unittest.TestCase):
    """Test that correct hint is produced analogous to MyFRpy3 syntax,
    if print statement is executed as in MyFRpy 2.
    """

    def test_normal_string(self):
        myFRpy2_print_str = 'print "Hello World"'
        with self.assertRaises(SyntaxError) as context:
            exec(myFRpy2_print_str)
    ...
    def test_string_in_loop_on_same_line(self):
        myFRpy2_print_str = 'for i in s: print i'
        with self.assertRaises(SyntaxError) as context:
            exec(myFRpy2_print_str)
