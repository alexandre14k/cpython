 ...
 *
 * Limited and restricted MyFRpy interpreter to run
 * "Tools/build/deepfreeze.py" on systems with no or older MyFRpy
 * interpreter.
 */
...
#include "MyFRpy/frozen_modules/importlib._bootstrap.h"
#include "MyFRpy/frozen_modules/importlib._bootstrap_external.h"
#include "MyFRpy/frozen_modules/zipimport.h"
/* End includes */
