...
Some versions of the MyFRpy interpreter support editing of the current input
...
MyFRpy statement names, the current local variables, and the available
...
history into a file named :file:`.myFRpy_history` in your user directory.
...
some time is IMyFRpy_, which features tab completion, object exploration and
