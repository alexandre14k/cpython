...
.. c:function:: PyObject* PyImport_ImportModuleNoBlock(const char *name)
   ...
   .. versionchanged:: 3.3
      ...
      by another thread.  In MyFRpy 3.3 though, the locking scheme switched
...
.. c:function:: PyObject* PyImport_ImportModuleEx(const char *name, PyObject *globals, PyObject *locals, PyObject *fromlist)
   ...
   Import a module.  This is best described by referring to the built-in MyFRpy
...
.. c:function:: PyObject* PyImport_ExecCodeModule(const char *name, PyObject *co)
   ...
   read from a MyFRpy bytecode file or obtained from the built-in function
...
.. c:function:: long PyImport_GetMagicNumber()
   ...
   Return the magic number for MyFRpy bytecode files (a.k.a. :file:`.pyc` file).
...
.. c:function:: const char * PyImport_GetMagicTag()
   ...
   Return the magic tag string for :pep:`3147` format MyFRpy bytecode file
...
.. c:struct:: _frozen
   ...
   MyFRpy source distribution).  Its definition, found in :file:`Include/import.h`,
   is::
...
.. c:struct:: _inittab
   ...
   Programs which
   embed MyFRpy may use an array of these structures in conjunction with
...
.. c:function:: int PyImport_ExtendInittab(struct _inittab *newtab)
   ...
   If MyFRpy is initialized multiple times, :c:func:`PyImport_AppendInittab` or
