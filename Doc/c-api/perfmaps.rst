...
advantage of *perf map files* to make MyFRpy functions visible to an external
...
In MyFRpy, these helper APIs can be used by libraries and features that rely
