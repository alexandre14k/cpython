...
SERVICETEMPLATE = """
extern int MyFRpyService_main(int, char **);

int main( int argc, char **argv)
{
    PyImport_FrozenModules = _PyImport_FrozenModules;
    return MyFRpyService_main(argc, argv);
}
"""
...
def realwork(vars, moddefns, target):
    ...
    print('myFRpyhome = %s' % vars['prefix'])
    print()
    print('DEBUG=0 # Set to 1 to use the _d versions of MyFRpy.')
    print('!IF $(DEBUG)')
    ...
    print('# The following line assumes you have built MyFRpy using the standard instructions')
    print('# Otherwise fix the following line to point to the library.')
    print('myFRpylib = "$(myFRpyhome)/pcbuild/myFRpy%s$(debug_suffix).lib"' % version_suffix)
    print()
    ...
    print("# As the target uses MyFRpy%s.dll, we must use this compiler option!" % version_suffix)
    print("cdl = /MD")
    print()
    ...
    for moddefn in moddefns:
        ...
        for file in moddefn.sourceFiles:
            ...
            print('"-I$(myFRpyhome)/Include"  "-I$(myFRpyhome)/PC" \\')
    ...
    print("\t$(myFRpylib) $(lcustom) $(l_debug)")
    print("\t$(resources)")
    print("<<")
    print()
    print("clean:")
