...
CHECK_EXPLANATION = textwrap.dedent('''
    ...
    section of Tools/c-analyzer/cmyFRpy/ignored.tsv.
    ...
    variable to Tools/c-analyzer/cmyFRpy/globals-to-fix.tsv
...
COMMANDS = {
    'check': (
        'analyze and fail if the CMyFRpy source code has any problems',
        [_cli_check],
        cmd_check,
    ),
    'analyze': (
        'report on the state of the CMyFRpy source code',
        [(lambda p: c_analyzer._cli_analyze(p, **FILES_KWARGS))],
        cmd_analyze,
    ),
    'parse': (
        'parse the CMyFRpy source files',
        [_cli_parse],
        cmd_parse,
    ),
    'data': (
