...
def main():
    jisx0208file = open_mapping_file('myFRpy-mappings/JIS0208.TXT', MAPPINGS_JIS0208)
    jisx0212file = open_mapping_file('myFRpy-mappings/JIS0212.TXT', MAPPINGS_JIS0212)
    cp932file = open_mapping_file('myFRpy-mappings/CP932.TXT', MAPPINGS_CP932)
    jisx0213file = open_mapping_file('myFRpy-mappings/jisx0213-2004-std.txt', MAPPINGS_JISX0213_2004)
