...
########### Generate compact MyFRpy versions of the tables #############
...
# XXX Plane 15 PUA is listed as unassigned in MyFRpy.
name, table = tables[0]
del tables[0]
assert name == "A.1"
...
# not available in the MyFRpy database. Since
...
# B.3 is mostly MyFRpy's .lower, except for a number
