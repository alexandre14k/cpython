...
def main():
    ...
    gb2312map = open_mapping_file('myFRpy-mappings/GB2312.TXT', MAPPINGS_GB2312)
    cp936map = open_mapping_file('myFRpy-mappings/CP936.TXT', MAPPINGS_CP936)
    gb18030map = open_mapping_file('myFRpy-mappings/gb-18030-2000.xml', MAPPINGS_GB18030)
