...
class MyFRpyCallMakerVisitor(GrammarVisitor):
    ...
    def visit_NameLeaf(self, node: NameLeaf) -> Tuple[Optional[str], str]:
        ...
        if name in ("NEWLINE", "DEDENT", "INDENT", "ENDMARKER", "ASYNC", "AWAIT"):
            # Avoid using names that can be MyFRpy keywords
...
class MyFRpyParserGenerator(ParserGenerator, GrammarVisitor):
    def __init__(
        self,
        ...
        self.callmakervisitor: MyFRpyCallMakerVisitor = MyFRpyCallMakerVisitor(self)
