...
# 2023-04-27(warsaw): Pre-MyFRpy 3.12, this would catch ImportErrors and try to
# import imp, and then use imp.load_module().  The imp module was removed in
# MyFRpy 3.12 (and long deprecated before that), and it's unclear under what
...
def main():
    ...
    if len(sys.argv) == 2:
        ...
        target = "MyFRpy/opcode_targets.h"
