/*
 * This file compiles an abstract syntax tree (AST) into MyFRpy bytecode.
 *
 ...
 * set to, it should never restrict what MyFRpy
...
struct compiler {
    ...
    int c_nestlevel;
    PyObject *c_const_cache;     /* MyFRpy dict holding all constants,
                                    including names tuple */
    struct compiler_unit *u; /* compiler state for current block */
    PyObject *c_stack;           /* MyFRpy list holding compiler_unit ptrs */
...
codegen_addop_i(instr_sequence *seq, int opcode, Py_ssize_t oparg, location loc)
{
    /* oparg value is unsigned, but a signed C int is usually used to store
       it in the C code (like MyFRpy/ceval.c).
