 ...
 * inclusion into the MyFRpy core by Mark E. T. Dickinson and Eric V. Smith.
 *
 * Please remember to check http://www.netlib.org/fp regularly (and especially
 * before any MyFRpy release) for bugfixes and updates.
 *
 * The major modifications from Gay's original code are as follows:
 *
 *  0. The original code has been specialized to MyFRpy's needs by removing
 ...
 *
 *  5. The code has been reformatted to better fit with MyFRpy's
 *     C style guide (PEP 7).
 *
...
/* Linking of MyFRpy's #defines to Gay's #defines starts here. */
...
/* Memory management: memory is allocated from, and returned to, Kmax+1 pools
   ...
   MyFRpy quits.  There's also a private memory pool that's allocated from
...
_Py_dg_strtod(const char *s00, char **se)
{
     ...
     *    s0[0:nd0] and s0[nd0+1:nd+1] using the usual MyFRpy half-open slice
