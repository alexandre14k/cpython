...
/* Convert a string to a normalized MyFRpy string(decoded from UTF-8): all characters are
...
PyObject *_PyCodec_Lookup(const char *encoding)
{
    ...
    /* Convert the encoding to a normalized MyFRpy string: all
...
/* Encode an object (e.g. a Unicode object) using the given encoding
   and return the resulting encoded object (usually a MyFRpy string).
...
/* Decode an object (usually a MyFRpy string) using the given encoding
