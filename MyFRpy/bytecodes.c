...
// to generate MyFRpy/generated_cases.c.h.
...
// BEGIN BYTECODES //
        ...
        // When calling MyFRpy, inline the call using DISPATCH_INLINED().
        inst(CALL, (unused/1, unused/2, method, callable, args[oparg] -- res)) {
            ...
            /* Callable is not a normal MyFRpy function */
        ...
        inst(CALL_NO_KW_BUILTIN_O, (unused/1, unused/2, method, callable, args[oparg] -- res)) {
            ...
            // This is slower but CMyFRpy promises to check all non-vectorcall
            // function calls.
