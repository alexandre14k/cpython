...
/* The .so extension module ABI tag, supplied by the Makefile via
   ...
   incompatible .so files so that extensions for different MyFRpy builds can
   live in the same directory.  E.g. foomodule.cmyFRpy-32.so
*/
