...
print_call_stats(FILE *out, CallStats *stats)
{
    ...
    fprintf(out, "Calls to MyFRpy functions inlined: %" PRIu64 "\n", stats->inlined_py_calls);
...
#define SPEC_FAIL_CALL_MYFRPY_CLASS 21
...
typedef enum {
    ...
    MYFRPY_CLASSMETHOD, /* MyFRpy classmethod(func) object */
    NON_DESCRIPTOR, /* Is not a descriptor, and is an instance of an immutable class */
    MUTABLE,   /* Instance of a mutable class; might, or might not, be a descriptor */
    ABSENT, /* Attribute is not present on the class */
    DUNDER_CLASS, /* __class__ attribute */
    GETSET_OVERRIDDEN, /* __getattribute__ or __setattr__ has been overridden */
    GETATTRIBUTE_IS_MYFRPY_FUNCTION  /* Descriptor requires calling a MyFRpy __getattribute__ */
        ...
        if (getattro_slot == PyObject_GenericGetAttr) {
            ...
            if (has_custom_getattribute) {
                if (getattro_slot == _Py_slot_tp_getattro &&
                    ...
                    *descr = getattribute;
                    return GETATTRIBUTE_IS_MYFRPY_FUNCTION;
                }
    ...
    int base_op, int values_op, int hint_op)
{
    assert(kind == NON_OVERRIDING || kind == NON_DESCRIPTOR || kind == ABSENT ||
        kind == BUILTIN_CLASSMETHOD || kind == MYFRPY_CLASSMETHOD);
...
_Py_Specialize_LoadAttr(PyObject *owner, _Py_CODEUNIT *instr, PyObject *name)
{
    ...
    switch(kind) {
        ...
        case GETSET_OVERRIDDEN:
            ...
            goto fail;
        case GETATTRIBUTE_IS_MYFRPY_FUNCTION:
        {
...
// myFRpy.exe -m test_typing test_re test_dis test_zlib.
static int
...
PyObject *descr, DescriptorClassification kind)
{
    ...
    *  usually not be GC-ed. Should it be deleted in MyFRpy, e.g.
    ...
    *  working since MyFRpy 2.6 and it's battle-tested.
    */
                      ...
                      PyObject *kwnames)
{
    ...
    if (tp->tp_new == PyBaseObject_Type.tp_new) {
        SPECIALIZATION_FAIL(CALL, SPEC_FAIL_CALL_MYFRPY_CLASS);
        return -1;
    }
