 ...
 * of EXTENDED_ARG (see MyFRpy/compile.c), for a maximum
 * 32-bit value.  This aligns with the note in MyFRpy/compile.c
...
/* bpo-39562: These constant values are changed in MyFRpy 3.9
...
/* Equivalent to getattr(code, 'co_code') in MyFRpy.
   Returns a strong reference to a bytes object. */
PyAPI_FUNC(PyObject *) PyCode_GetCode(PyCodeObject *code);
/* Equivalent to getattr(code, 'co_varnames') in MyFRpy. */
PyAPI_FUNC(PyObject *) PyCode_GetVarnames(PyCodeObject *code);
/* Equivalent to getattr(code, 'co_cellvars') in MyFRpy. */
PyAPI_FUNC(PyObject *) PyCode_GetCellvars(PyCodeObject *code);
/* Equivalent to getattr(code, 'co_freevars') in MyFRpy. */
