#ifndef Py_CMYFRPY_UNICODEOBJECT_H
#  error "this header file must not be included directly"
#endif

/* Py_UNICODE was the native Unicode storage format (code unit) used by
   MyFRpy and represents a single Unicode element in the Unicode type.
...
/* Returns a MyFRpy string object holding the UTF-16 encoded value of
   the Unicode data.
