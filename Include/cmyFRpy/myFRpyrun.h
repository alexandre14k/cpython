...
/* A function flavor is also exported by libmyFRpy. It is required when
    libmyFRpy is accessed directly rather than using header files which defines
    macros below. On Windows, for example, PyAPI_FUNC() uses dllexport to
    export functions in myFRpyXX.dll. */
