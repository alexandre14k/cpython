#ifndef Py_CMYFRPY_PTRHEAD_STUBS_H
#define Py_CMYFRPY_PTRHEAD_STUBS_H
...
/* Minimal pthread stubs for CMyFRpy.
 *
 * The stubs implement the minimum pthread API for CMyFRpy.
...
#endif // Py_CMYFRPY_PTRHEAD_STUBS_H
